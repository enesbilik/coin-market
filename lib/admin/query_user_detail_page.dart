...
class QueryUserDetailPage extends StatefulWidget {
  String _selectedUserId;

  QueryUserDetailPage(this._selectedUserId);

  @override
  _QueryUserDetailPageState createState() => _QueryUserDetailPageState();
}

class _QueryUserDetailPageState extends State<QueryUserDetailPage> {
